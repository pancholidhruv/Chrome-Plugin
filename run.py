...
def get_product_toolbar():
    ...
    headers = {
        ...
        'Referer': 'https://www.flipkart.com/search?q='+q+'&marketplace=FLIPKART&sid=search.flipkart.com',
    ...
    for productSummarySlot in productSummarySlots:
        for product in productSummarySlot["widget"]["data"]["products"]:
            productUrl = product["productInfo"]["action"]["url"]
            ...
            productSummarySlotList.append(ProductSummarySlot(productUrl,
                                                             imageUrl, isFAssured, rating,
                                                             title,
                                                             totalDiscount,
                                                             mrp,
                                                             finalPrice))

    mapiModel = MapiModel(productCount, productSummarySlotList)
